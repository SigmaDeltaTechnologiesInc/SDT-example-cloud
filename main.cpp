...
static M2MResource* sigma_res;      // For test by SDT
static M2MResource* delta_res;      // For test by SDT
...
void main_application(void)
{
    ...
    // Create resource for test. Path of this resource will be: 3200/0/8000.
    sigma_res = mbedClient.add_cloud_resource(3200, 0, 8000, "sigma_resource", M2MResourceInstance::INTEGER,
                                              M2MBase::GET_ALLOWED, 0, true, NULL, (void*)notification_status_callback);

    // Create resource for test. Path of this resource will be: 3200/0/8001.
    delta_res = mbedClient.add_cloud_resource(3200, 0, 8001, "delta_resource", M2MResourceInstance::INTEGER,
                                              M2MBase::GET_ALLOWED, 0, true, NULL, (void*)notification_status_callback);
